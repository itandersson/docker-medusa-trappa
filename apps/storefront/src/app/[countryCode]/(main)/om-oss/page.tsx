      ...
      <div className="content-container py-12">
        ...
        <p className="text-ui-fg-subtle">
          <p>
            ...
            pålitlighet ser vi till att trapphus och gemensamma utrymmen alltid
            är rena, välkomnande och trivsamma.
          </p>
          <br />
          <br />
          <br />
            ...
            <div className="space-y-8">
              <section className="rounded-3xl border border-neutral-200 bg-white p-6 shadow-sm dark:border-neutral-800 dark:bg-neutral-950">
                ...
                <p className="mt-3 text-sm text-neutral-600 dark:text-neutral-400">
                  ...
                  varje uppdrag utförs med omsorg. Steg för steg bygger vi upp
                  ett företag där hantverket, noggrannheten och kundkontakten
                  står i centrum.
                </p>
              </section>
              ...
              <section className="rounded-3xl border border-neutral-200 bg-white p-6 shadow-sm dark:border-neutral-800 dark:bg-neutral-950">
                ...
                <p className="mt-3 text-sm text-neutral-600 dark:text-neutral-400">
                  ...
                  digitala lösningar via webben och telefon, så att du snabbt
                  kan få den hjälp du behöver — utan krångel.
                </p>
              </section>
            </div>
